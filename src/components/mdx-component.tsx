...
const components: MDXComponents = {
  h1: props => (
    <h1
      className="font-bold text-3xl text-foreground my-8 hover:after:content-['#'] after:mx-1 after:text-neutral-200"
      {...props}>
      {props.children}
    </h1>
  ),
  h2: props => (
    <h2
      className="font-bold text-2xl text-foreground my-7 hover:after:content-['#'] after:mx-1 after:text-neutral-200"
      {...props}>
      {props.children}
    </h2>
  ),
  h3: props => (
    <h3
      className="font-bold text-xl text-foreground mt-6 mb-4 hover:after:content-['#'] after:mx-1 after:text-neutral-200"
      {...props}>
      {props.children}
    </h3>
  ),
  h4: props => (
    <h4
      className="font-bold text-lg text-foreground mt-2 mb-0.5 hover:after:content-['#'] after:mx-1 after:text-neutral-200"
      {...props}>
      {props.children}
    </h4>
  ),
  h5: props => (
    <h5
      className="font-semibold text-base text-foreground mt-1 mb-0.5 hover:after:content-['#'] after:mx-1 after:text-neutral-200"
      {...props}>
      {props.children}
    </h5>
  ),
  ...
  table: props => (
    <table
      className="text-foreground border-collapse table-auto my-4"
      {...props}>
      {props.children}
    </table>
  ),
  thead: props => (
    <thead
      className="text-foreground rounded-lg bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50"
      {...props}>
      {props.children}
    </thead>
  ),
